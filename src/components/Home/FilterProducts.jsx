    ...
    <section className="mt-[10%] w-full flex flex-col justify-center items-center">
      <div className="w-full flex flex-row justify-center items-start">
        ...
        <aside className="flex flex-col justify-center items-center w-max max-w-6xl">
          <div className="w-full flex justify-between items-end pt-6 px-4 text-lg ">
            ...
            {/* <select
              name="order"
              id="order"
              className="select max-w-max w-full bg-slate-50"
              defaultValue={"Ordernar por"}
            >
              <option disabled hidden>
                Ordenar por
              </option>
              <option
                className=" hover:bg-orange hover:text-orange transition-all text-lg "
                value="relevant"
              >
                Relevancia
              </option>
