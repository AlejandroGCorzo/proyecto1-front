                ...
                <div>
                  ...
                  <div className="leading-tight text-sm">
                    <p>
                      ...
                      contando a partir de la fecha en que recibiste tu compra.
                    </p>
                    <ul className="list-disc ml-4">
                      ...
                      <li>
                        Al momento del cambio se debe tener la factura de compra
                        o ticket de cambio.
                      </li>
                    </ul>
                  </div>
                ...
                <div>
                  ...
                  <div className="leading-tight text-base w-full">
                    ...
                    <p className="mt-6 mb-6 border border-gray-300 border-t-2 border-b-2 text-lg">
                      ...
                      Solo válido para compras de domingos a jueves, únicamente
                      para AMBA y CABA.
                    </p>
                  </div>
                </div>
