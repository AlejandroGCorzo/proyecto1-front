          ...
          <div className="mt-4 mx-auto sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto">
            ...
            <div className="flex mt-2 mx-auto w-auto sm:mx-auto md:mx-auto lg:mx-auto xl:mr-1">
              {detailProduct?.talle.map((size) => (
                <div
                  key={size.talle}
                  className={`border border-gray-300 rounded-md xsm:mx-4 sm:mx-4 md:mr-0 lg:p-2 xl:p-3 ${selectedSize === size.talle
                      ? "bg-black text-white"
                      : "bg-white text-black"} cursor-pointer ${size.cantidad === "0" ? "line-through" : ""}`}
