 ...
 />
  ...
  <tr>
    ...
    <td className="bg-gray-100 text-left px-4 py-2">{detailProduct.marca}</td>
      ...
      <img src={detailProduct.icono} alt="Logo del producto" className="w-12 h-12 mb-2" />
        ...
        <div>
        <button onClick={handleToggleTooltip} className="flex items-center mt-8">
        <img src="https://static.vecteezy.com/system/resources/thumbnails/000/357/048/small/3__2821_29.jpg" alt="Icono" className="w-6 h-6 mr-2" />
          <p className="mr-2">Cuotas sin interés</p>
          <p className="text-blue-500 underline">- Ver más</p>
        </button>
        <Modal id="tooltipModal" isOpen={isTooltipOpen} onClose={handleToggleTooltip}>
  <div className="bg-white text-black p-4">
    ...
    <div>
      ...
      <div>
        <button onClick={handleToggleCambio} className="flex items-center mt-8">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDkcZd8dnBz1_rpOggGdJhtN-Za3GgJ0cYBoxZ2Ls7sQ&s" alt="Icono" className="w-6 h-6 mr-2" />
          <p className="mr-2">Cambios gratis en sucursales</p>
          <p className="text-blue-500 underline">- Ver más</p>
        </button>
        <Modal id="cambioModal" isOpen={isCambioOpen} onClose={handleToggleCambio}>
          <div className="bg-white text-black p-4">
            <div>
              ...
              <div className="leading-tight text-sm">
                ...
                <ul className="list-disc ml-4">
                  ...
                  <li>El producto debe poseer sus etiquetas, envoltorios y todos los accesorios adicionales con los que fue adquirido.</li>
                  <li>En caso de realizar el cambio por correo, el mismo debe estar envuelto en una bolsa negra o de papel madera.</li>
                  <li>Al momento del cambio se debe tener la factura de compra o ticket de cambio.</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <hr className="w-full border-gray-300 mt-2" />
      <div>
  <button onClick={handleToggleSucursales} className="flex items-center mt-8">
  ...
  <Modal id="sucursalesModal" isOpen={isSucursalesOpen} onClose={handleToggleSucursales}>
  ...
  <div>
    ...
    <div className="leading-tight text-base w-full">
      <p className="mt-6 mb-6 border border-gray-300 border-t-2 border-b-2 p-4">GRID JOSÉ C.PAZ - José C.Paz 1784</p>
      <p className="mt-6 mb-6 border border-gray-300 border-t-2 border-b-2 p-4">MARK MARTINEZ - Av. Panamericana 535 esq Edison</p>
      <p className="mt-6 mb-6 border border-gray-300 border-t-2 border-b-2 p-4">DASH SAN MARTIN - Belgrano 3607</p>
      <p className="mt-6 mb-6 border border-gray-300 border-t-2 border-b-2 p-4">GRID CONSTITUYENTES - Av. Constituyentes 6020</p>
      <p className="mt-6 mb-6 border border-gray-300 border-t-2 border-b-2 p-4">DASH GRAN BOURG - Colectora Panamericana KM34 Ramal Escobar</p>
      <p className="mt-6 mb-6 border border-gray-300 border-t-2 border-b-2 p-4">DASH PILAR - Colectora Panamericana KM 54 Ramal Pilar</p>
      <p className="mt-6 mb-6 border border-gray-300 border-t-2 border-b-2 p-4">GRID SAN MIGUEL - Av. Presidente Perón 1320</p>
      <p className="mt-6 mb-6 border border-gray-300 border-t-2 border-b-2 p-4">DASH JOSÉ C. PAZ - José C. Paz 1827</p>
      <p className="mt-6 mb-6 border border-gray-300 border-t-2 border-b-2 p-4">DASH PILAR - Rivadia 744</p>
      <p className="mt-6 mb-6 border border-gray-300 border-t-2 border-b-2 p-4">GRID MORÓN - Av. Rivadavia 18276</p>
      <p className="mt-6 mb-6 border border-gray-300 border-t-2 border-b-2 p-4">GRID SAN JUSTO SHOPPING - Brigadier Juan Manuel de Rosas 3910</p>
    </div>
  </div>
</div>
...
<hr className="w-full border-gray-300 mt-2" />
      <div>
  <button onClick={handleToggleEnvio} className="flex items-center mt-8">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOFh3pmCoUR5XuBsyixzgQxrRbruxRyg80YQ&usqp=CAU" alt="Icono" className="w-8 h-8 mr-2" />
    <p className="mr-2">Envios</p>
    <p className="text-blue-500 underline">- Ver más</p>
  </button>
  <Modal id="envioModal" isOpen={isEnvioOpen} onClose={handleToggleEnvio}>
  <div className="bg-white text-black p-4">
  <div>
    ...
    <div className="leading-tight text-base w-full">
      ...
      <p className="mt-6 mb-6 border border-gray-300 border-t-2 border-b-2 text-lg">
        Envío express en 24hs a domicilio a través de Andreani. Solo válido para compras de domingos a jueves, únicamente para AMBA y CABA.
      </p>
    </div>
  </div>
</div>
