      ...
      <div className="flex flex-col w-3/4 sm:w-1/2 lg:w-[40%] xl:w-[35%] 2xl:w-[20%] bg-white transform transition-transform duration-300 ease-in-out h-auto">
        ...
        {productos?.length ? (
          <div className="w-full h-full flex flex-col justify-center items-center bg-white">
            <div className="max-h-[70%] h-[60%] md:max-h-[55%] w-full px-2 self-start overflow-y-auto">
            ...
            <div className="h-auto xl:max-h-72 flex flex-col w-full justify-center items-center">
              <div className="h-48 lg:h-72 w-full flex flex-col justify-center items-center px-6 py-4 border-t ">
